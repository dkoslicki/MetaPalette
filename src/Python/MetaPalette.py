#This is the MetaPalette package that contains the main algorithms
#It is called from the scripts Train.py, Classify.py, and Plot.py
...
def Train(input_files, output_folder, bcalm_binary, ramdisk_location, jellyfish_binary, count_in_file_binary, num_threads, kmer_counting_threads, chunk_size):
